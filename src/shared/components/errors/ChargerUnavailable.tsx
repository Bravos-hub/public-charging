...
export function ChargerUnavailable(): React.ReactElement {
  const station = { name: 'Central Hub — Downtown Mall', unit: 'EVSE EVZ-123', connector: 'CCS2', power: '60kW', state: 'Faulted' };
  return (
    <div className="min-h-[100dvh] bg-white">
      ...
      <div className="px-4 pt-4 pb-6">
        ...
        <div className="p-4 rounded-xl bg-rose-50 border border-rose-200">
          ...
          <div className="text-xs text-red-800 mt-1">Status: {station.state}</div>
        </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          ...
          <div className="p-3 rounded-xl border border-slate-200 bg-white">
            ...
            <div className="text-[13px] font-semibold inline-flex items-center gap-1.5">
              ...
              <span>{station.unit} • {station.connector}</span>
            </div>
            <div className="text-[13px] font-semibold mt-1">{station.power}</div>
          </div>
        </div>
        ...
        <div className="mt-4 flex gap-3">
          ...
          <button className="h-10 px-4 rounded-xl border border-slate-300 bg-white text-slate-700 inline-flex items-center justify-center gap-2 hover:bg-slate-50 transition-colors">
        ...
        {/* Retry Status button */}
        <div className="mt-3">
          <button className="h-10 w-full rounded-xl border border-slate-300 bg-white text-slate-700 inline-flex items-center justify-center gap-2 hover:bg-slate-50 transition-colors">
